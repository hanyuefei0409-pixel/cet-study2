const SHELL='cet-study-shell-v11';
const RUNTIME='cet-study-runtime-v11';
const ASSETS=['./','./index.html','./manifest.json','./icon.svg','./vocab-data.js','./exam-data.js','./cet6-exam-data.js','./data/questions.js','./data/extra_questions.js','./data/practice-data.js','./config.js','./vendor/pdf.min.js','./vendor/pdf.worker.min.js'];
