const SHELL='cet-study-shell-v19';
const RUNTIME='cet-study-runtime-v19';
const ASSETS=['./','./index.html','./manifest.json','./icon.svg','./vocab-data.js','./exam-data.js','./cet6-exam-data.js','./data/questions.js','./data/extra_questions.js','./data/practice-data.js','./data/full-mock-data.js','./data/licensed-cet4-mocks.js','./data/licensed-cet6-mocks.js','./config.js','./vendor/pdf.min.js','./vendor/pdf.worker.min.js'];
