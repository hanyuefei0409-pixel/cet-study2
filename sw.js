const SHELL='cet-study-shell-v10';
const RUNTIME='cet-study-runtime-v10';
const ASSETS=['./','./index.html','./manifest.json','./icon.svg','./vocab-data.js','./exam-data.js','./data/questions.js','./data/extra_questions.js','./config.js','./vendor/pdf.min.js','./vendor/pdf.worker.min.js'];
